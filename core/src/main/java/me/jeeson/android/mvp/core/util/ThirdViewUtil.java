...
public class ThirdViewUtil {
    ...
    private final static String LAYOUT_LINEARLAYOUT = "LinearLayout";
    private final static String LAYOUT_FRAMELAYOUT = "FrameLayout";
    private final static String LAYOUT_RELATIVELAYOUT = "RelativeLayout";
